...
/**
 * DistrictId generated by hbm2java
 */
@Embeddable
public class DistrictId implements java.io.Serializable {
	...
	public DistrictId(String id, String stateId, String countryId) {
		this.id = id;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof DistrictId))
			return false;
		DistrictId castOther = (DistrictId) other;
