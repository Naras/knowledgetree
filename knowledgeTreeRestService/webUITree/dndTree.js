...
function getauth() {
    ...
    i_ampersandTwo = restOftext.indexOf("&orientation=") + 1;

    uname = text.substring(i_uname, i_ampersandOne - 1);
    // psw = restOftext.substring(i_password, i_ampersandTwo - 1);
    if (i_ampersandTwo == 0) {
        psw = restOftext.substring(i_password);
        orientation = false;
    } else {
        psw = restOftext.substring(i_password, i_ampersandTwo - 1);
        orientation = true;
